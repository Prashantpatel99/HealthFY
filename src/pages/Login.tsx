    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md border-gray-200 shadow-md">
        <CardHeader className="text-center bg-recipe-light border-b border-gray-200">
          <CardTitle className="text-2xl font-bold text-recipe-primary">Sign in to your account</CardTitle>
          <CardDescription>
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Button variant="outline" className="w-full" onClick={() => toast.info("Google login will be implemented with Supabase.")}>
