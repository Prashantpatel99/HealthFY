  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md border-gray-200 shadow-md">
        <CardHeader className="text-center bg-recipe-light border-b border-gray-200">
          <CardTitle className="text-2xl font-bold text-recipe-primary">Create an account</CardTitle>
          <CardDescription>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-recipe-primary hover:bg-green-600">
              Sign up
            </Button>
          </form>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Button variant="outline" className="w-full" onClick={() => toast.info("Google signup will be implemented with Supabase.")}>
